...
class Maximisation:
    ...
    def construction_tableau(self):
        ...
        self.table[2,1]=1
        self.table[3,1]=2
        self.table[0,-1]=0 #Valeur de b dans les contraintes 
        self.table[1,-1]=2
        self.table[2,-1]=6
        self.table[3,-1]=18
    ...
    def preliminaires(self):
        ...
        #     self.table[0,j]=self.table[0,j]-self.M*(self.table[1,j]+self.table[self.nb_contraintes,j])
    ...
    def transformation(self):
        ...
        print('Transformation:',self.table)
        return(self.table)
